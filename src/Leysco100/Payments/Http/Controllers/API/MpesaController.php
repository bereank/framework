...
use Leysco100\Payments\Traits\MpesaTrait;
...
class MpesaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->c2bconfirm = "https://dev100-be.leysco100.com/api/v1/payments/incoming/third-party/confirmation-url";
        $this->c2bvalidate = "https://dev100-be.leysco100.com/api/v1/payments/incoming/third-party/validation-url";
    ...
    public function stkpush($phonenumber, $amount, $account_number, $callbackurl = null)
    {
        ...
        if (!is_null($callbackurl) && is_null($this->stkcallback)) {
            ...
            return (new ApiResponseService())->apiFailedResponseService(
                'callback_url',
    ...
    public function MpesaConfirmation(Request $request)
    {
        ...
        $transaction =   OCRP::create([
            'MSISDN' => $paymentPhoneNumber ?? "",
            'TransAmount' => $amountPaid ?? 0,
        ]);
    }
}
