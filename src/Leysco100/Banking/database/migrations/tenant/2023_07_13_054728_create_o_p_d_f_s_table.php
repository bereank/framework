...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('o_p_d_f_s', function (Blueprint $table) {
            ...
            $table->string('CounterRef', 1)->nullable();
            ...
            $table->string('U_Mpesa', 50)->nullable();
            $table->string('U_MRef', 200)->nullable();

            $table->string('ExtRef')->nullable()->comment("External Ref");
            $table->string('ExtRefDocNum')->nullable()->comment("External Ref Document Number");
