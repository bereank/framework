...
class GPMInstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // $packageComposer = json_decode($composerData, true);

        // LS100Module::updateOrCreate([
        //     'RepoPath' => $packageComposer['name'],
        // ],
        //     [
        //         'ModuleDescription' => $packageComposer['description'],
        //         'installed' => 1,
        //     ]);
        ...
        $this->callSilent('vendor:publish', [
            '--provider' => 'Leysco\GatePassManagementModule\GatePassManagementModuleServiceProvider',
            '--tag' => 'migrations',
        ]);
