        ...
        if ($timeDiff < $Duration) {
            ...
            if ($affectedRows > 0) {
                ...
                if ($updatedModel) {
                    ...
                    $message = 'Back-up mode Deactivated GPM Documents started syncing. Activated on ' .
                        $updatedModel->StartDate . ' ' . $updatedModel->StartTime  . ' and Deactivated on ' .
                        $updatedModel->EndTime;
