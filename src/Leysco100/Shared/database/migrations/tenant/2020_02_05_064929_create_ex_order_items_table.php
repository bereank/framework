...
class CreateExOrderItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ex_order_items', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('DocEntry')
                ->references('id')->on('ex_orders');
            $table->integer('LineNum')->nullable();
            $table->string('TargetType', 11)->default(-1);
            $table->string('TrgetEntry', 1)->nullable();
            $table->string('BaseRef', 16)->nullable();
            $table->string('BaseType', 11)->default(-1);
            $table->string('BaseEntry', 11)->nullable();
            ...
            $table->string('GrossBuyPr', 1)->nullable();
            $table->string('PriceBefDi', 1)->nullable();
            $table->date('DocDate')->nullable();
            $table->string('Flags', 1)->nullable();
            $table->string('OpenCreQty', 1)->nullable();
            $table->string('UseBaseUn', 1)->nullable();
            ...
            $table->string('PriceAfVAT', 1)->nullable();
            ...
            $table->string('PackQty', 1)->nullable();
            ...
            $table->string('GrssProfit', 1)->nullable();
            ...
            $table->string('PoTrgNum', 1)->nullable();
            ...
            $table->string('unitMsr', 1)->nullable();
            $table->string('NumPerMsr', 1)->nullable();
            ...
            $table->string('GTotal', 1)->nullable();
            ...
            $table->string('DelivrdQty', 1)->nullable();
            $table->string('OrderedQty', 1)->nullable();
            ...
            $table->string('GPTtlBasPr', 1)->nullable();
            ...
            $table->string('UomCode', 1)->nullable();
            $table->string('UomCode2', 1)->nullable();
            ...
            $table->string('InvQty', 1)->nullable();
            $table->string('OpenInvQty', 1)->nullable();
    ...
    {
        Schema::dropIfExists('ex_order_items');
    }
}
