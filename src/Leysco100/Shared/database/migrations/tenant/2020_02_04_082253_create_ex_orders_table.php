...
class CreateExOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ex_orders', function (Blueprint $table) {
            ...
            $table->string('DocStatus', 1)->default('0');
            $table->string('InvntSttus', 1)->default('O');
            $table->string('Transfered', 1)->default('N');
            $table->string('ObjType', 17)->nullable();
            $table->string('DocDate', 30)->nullable();
            $table->string('DocDueDate', 30)->nullable();
            $table->integer('CardCode')
                ->references('id')->on('o_c_d_s')->nullable();
            $table->string('CardName', 1)->nullable();
            $table->string('Address', 254)->nullable();
            $table->string('NumAtCard', 1)->nullable();
