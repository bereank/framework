...
class CreateORINSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('o_r_i_n_s', function (Blueprint $table) {
            ...
            $table->float('DiscSum')->default(0);
            $table->string('DiscSumFC', 1)->nullable();
            $table->string('DocCur')->nullable();
            $table->float('DocRate', 19, 6)->default(0);
            $table->float('DocTotal', 19, 6)->default(0);
            ...
            $table->float('VatSumSy')->default(0);
            $table->float('DiscSumSy')->default(0);
            $table->float('DocTotalSy')->default(0);
            ...
            $table->float('PaidSum', 19, 6)->default(0);
            $table->float('PaidSumFc', 19, 6)->default(0);
            $table->float('PaidSumSc', 19, 6)->default(0);
