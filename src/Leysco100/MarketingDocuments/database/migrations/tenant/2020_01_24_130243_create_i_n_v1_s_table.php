...
class CreateINV1STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('i_n_v1_s', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('DocEntry')
                ->references('id')->on('o_i_n_v_s');
            ...
            $table->string('ObjType')->default(13);
            ...
            $table->float('QtyAssigned', 19, 6)->default(0); //Dispatch
