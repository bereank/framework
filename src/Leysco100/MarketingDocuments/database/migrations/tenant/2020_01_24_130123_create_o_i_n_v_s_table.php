...
class CreateOINVSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('o_i_n_v_s', function (Blueprint $table) {
            ...
            $table->float('PaidToDate', 19, 6)->nullable();
            ...
            $table->string('Comments')->nullable(); //Remarks
            ...
            $table->string("U_CashMail")->nullable();
