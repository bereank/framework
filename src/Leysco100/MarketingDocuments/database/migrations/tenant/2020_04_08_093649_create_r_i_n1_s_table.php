...
class CreateRIN1STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('r_i_n1_s', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('DocEntry')
                ->references('id')->on('o_r_i_n_s');
            ...
            $table->float('OpenQty', 19, 6)->default(0);
            $table->float('Price', 19, 6)->default(0);
            $table->string('Currency', 8)
                ->references('id')->on('currencies')->nullable();
            $table->float('Rate', 19, 6)->default(0);
            $table->float('DiscPrcnt', 19, 6)->default(0);
            $table->float('LineTotal', 19, 6)->default(0);
            $table->float('TotalFrgn', 19, 6)->default(0);
            $table->float('OpenSum', 19, 6)->default(0);
            $table->float('OpenSumFC', 19, 6)->default(0);
            ...
            $table->float('Commission', 19, 6)->default(0);
            ...
            $table->float('GrossBuyPr', 19, 6)->default(0);
            $table->float('PriceBefDi', 19, 6)->default(0);
            ...
            $table->float('PriceAfVAT', 19, 6)->default(0);
            ...
            $table->float('PackQty', 19, 6)->default(0);
            ...
            $table->float('VatSum', 19, 2)->default(0);
            ...
            $table->float('GrssProfit', 19, 6)->default(0);
            ...
            $table->float('StockPrice', 19, 6)->default(0);
            ...
            $table->float('GTotal', 19, 6)->default(0);
            ...
            $table->float('DelivrdQty', 19, 6)->default(0);
            $table->float('OrderedQty', 19, 6)->default(0);
            ...
            $table->float('GPTtlBasPr', 19, 6)->default(0);
            ...
            $table->float('InvQty', 19, 6)->default(0);
            $table->float('OpenInvQty', 19, 6)->default(0);
