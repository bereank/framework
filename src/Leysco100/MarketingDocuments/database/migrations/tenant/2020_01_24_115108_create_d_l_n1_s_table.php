...
class CreateDLN1STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('d_l_n1_s', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('DocEntry')
                ->references('id')->on('o_d_l_n_s');
            $table->integer('LineNum')->nullable();
            $table->integer('TargetType')->nullable();
            $table->integer('TrgetEntry')->nullable();
            ...
            $table->date('ActDelDate', 1)->nullable();
            ...
            $table->float('QtyAssigned', 19, 6)->nullable();
