...
class CreateODLNSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('o_d_l_n_s', function (Blueprint $table) {
            ...
            $table->string('U_ServiceCall')->nullable();
            ...
            $table->string('NumAtCard2', 100)->nullable();
