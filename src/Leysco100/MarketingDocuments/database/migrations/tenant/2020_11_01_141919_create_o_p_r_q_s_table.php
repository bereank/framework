...
class CreateOPRQSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('o_p_r_q_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('U_Technician')->nullable();
